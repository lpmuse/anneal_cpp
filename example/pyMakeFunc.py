...
parser.add_argument('-e', '--equations', action='store', default='equations.py')

# Import the equations module
equations.rstrip('.py')
importlib.import_module(equations)
import equations

# Get the problem name
try:
  Problem = equations.problem_name
except:
